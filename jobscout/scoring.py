...
_SYSTEM = (
    ...
    "when the description is empty or silent on it; do not infer a bar from the employer's "
    "industry. This must NOT move experience_score: rate fit as if the barrier were absent, "
    "so a strong-fit but ineligible role still scores high and is merely flagged.\n"
